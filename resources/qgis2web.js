...
map.getView().fit([10392024.316233, -6318611.028481, 17650528.208316, -655422.682910], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WA Public Buildings</h2>';
        return titleElement;
    })(),
